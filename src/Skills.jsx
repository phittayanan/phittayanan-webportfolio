...
import researchImage from './assets/dow-61864548498-rd-shortmast.avif';
import softwareImage from './assets/alberta-software-engineering-4x2.png';
import aiImage from './assets/0276.jpg_wh300.jpg-e1652677128201.webp';
    ...
    const skills = [
        {
            ...
            icon: <FaFlask size={40} color="#FFD700" />,
            image: researchImage
        },
        {
